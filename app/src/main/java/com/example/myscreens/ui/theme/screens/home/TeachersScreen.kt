...
fun TeachersScreen(navController:NavHostController) {
    Column(
        ...
        //end of row
        Text(text = "To teach is to learn twice over. A teacher affects eternity; he can never tell where his influence stops.",
            textAlign = TextAlign.Center,
...
fun TeachersScreenPreview(){
    MyScreensTheme {
        TeachersScreen(navController = rememberNavController())
    }
}